...
private:
	...
	void privLoadDataFromFile(const char* const _modelName, StandardVertex*& pVerts, int& nverts, TriangleByIndex*& ptlist, int& ntri, float scale = 1.0f);
...
public:
	...
	Model(ID3D11Device* dev, const char* const _modelName, float scale = 1.0f);
