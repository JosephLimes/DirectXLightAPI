...
void ShaderColorLight::SetPointLightParameters(int lightNum, const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLight::SetSpotLightParameters(int lightNum, const Vect& pos, float r, const Vect& att, const Vect& dir, float spotExp, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLight::SendFogData(const float& start, const float& range, const Vect& color)
{
